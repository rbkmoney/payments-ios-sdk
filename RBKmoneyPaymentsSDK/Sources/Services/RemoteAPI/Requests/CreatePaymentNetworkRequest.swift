...
/// https://developer.rbk.money/api/#operation/createPayment
struct CreatePaymentNetworkRequest: NetworkRequest {
    ...
    init(paymentParameters: PaymentParametersDTO, invoiceIdentifier: String, invoiceAccessToken: String) throws {
        ...
        bodyParameters = .rawJSON(try encoder.encode(paymentParameters))
